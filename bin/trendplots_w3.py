...
def main(processedcsvfile_w3: str, out1pngfile:str, out2pngfile:str, out3pngfile: str):
    ...
    xticks = [df_w3['month'].iloc[i] for i in range(1,len(df_w3['month']),6)]
    # first plot
    logger.debug('Plot trends for new_deaths vs new_cases')
    fig1, ax11, ax21 = compare_trends(df_w3['new_deaths'], df_w3['new_cases'],  df_w3['month'])
    ...
    fig2, ax12, ax22 = compare_trends(df_w3['new_deaths'], df_w3['new_vaccinations'],  df_w3['month'])
    ...
    fig3, ax13, ax23 = compare_trends(df_w3['deaths_vs_cases'], df_w3['new_vaccinations'],  df_w3['month'])
...
if __name__ == '__main__':
    ...
    main(args.processedcsvfile_w3, args.out1pngfile, args.out2pngfile, args.out3pngfile)
